...
MySQL - 10.1.31-MariaDB : Database - db_reg
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_reg` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `tbl_customer`(`CustomerID`,`CustomerName`,`ContactName`,`Address`,`City`,`PostalCode`,`Country`) values 
...
(2,'Dalisay3','Ricardo3','fd3','Quezon City3'),
(3,'Villanueva Jr.','George','Ramos','Magsaysay, Tagudin, Ilocos Sur'),
(4,'Mendoza','Zeus','m','Bacnotan'),
(5,'Bea','Joy','ff','Tagudin'),
(38,'Flores','Calvin','Caguioa','Bangar'),
(40,'Villanueva','George Jr.','Ramos','magsaysay'),
(49,'Delos Reyes','Jim-mar','Flor','las-ud');
